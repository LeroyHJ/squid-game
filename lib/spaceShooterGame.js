class SpaceShooterGame {
  ...
  run = (callback) => {
    ...
    //createPlayer -- need to remove player?
    //createEnemies -- need to remove enemies?
    // this.$container.removeChild($player);
    // this.$container.removeChild($enemy);
    // this.createPlayer(this.$container) = false;
    // this.createEnemies(this.$container) = false;
...
module.exports = SpaceShooterGame;
